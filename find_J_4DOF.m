function J = find_J_4DOF(q1,q2,q3,q4,beta1,beta2,beta3,m2,m3,m4)
    ...
    dq2_dm = [dq2_dm1 dq2_dm2 0 0];
    dq3_dm = [dq3_dm1 dq3_dm2 dq3_dm3 0];
    dq4_dm = [dq4_dm1 dq4_dm2 dq4_dm3 dq4_dm4];

    W1 = T1(1:3,1:3)*[0 1 0]'*[1 0 0 0];
    W2 = T1(1:3,1:3)*T2(1:3,1:3)*[1 0 0]'*dq2_dm;
    W3 = T1(1:3,1:3)*T2(1:3,1:3)*T3(1:3,1:3)*[1 0 0]'*dq3_dm;
    W4 = T1(1:3,1:3)*T2(1:3,1:3)*T3(1:3,1:3)*T4(1:3,1:3)*[1 0 0]'*dq4_dm;
    W = W1+W2+W3+W4;

    J = [dT_dm1(1:3, 4), dT_dm2(1:3, 4), dT_dm3(1:3, 4), dT_dm4(1:3,4); W ];
end
